...
client.on('message', async message => {
  ...
  if(!kontrol) return;
  if(message.content.toLowerCase() == 'sa' || message.content.toLowerCase() == 'selamun aleyküm' || message.content.toLowerCase() == 'selamün aleyküm' || message.content.toLowerCase() == 'selamın aleyküm' || message.content.toLowerCase() == 'selamın aleykum' || message.content.toLowerCase() == 'selamün aleykum' || message.content.toLowerCase() == 'sea' || message.content.toLowerCase() == 'selam' || message.content.toLowerCase() === 'selamlar') {
...
client.on("message", async msg => {
  ...
  if (db.fetch(`puan_${msg.author.id + msg.guild.id}`) > 300) {
